...
breach_sound = pygame.mixer.Sound("AA_breach.wav")
bacteria_hit_sound = pygame.mixer.Sound("AA_bacteria_fire.wav")
nanobot_hit_sound = pygame.mixer.Sound("AA_nanobot_hit.wav")
game_over_sound=pygame.mixer.Sound("AA_game_over.wav")
game_win=pygame.mixer.Sound("AA_game_win.mp3")
...
while running:
    ...
    lives_text = font.render(f"Score: {nanobot.lives}", True, WHITE)
    lives_rect = lives_text.get_rect(topright = (WINDOW_WIDTH // 2, 70))
    
    screen.blit(score_text, score_rect)
    screen.blit(lives_text, lives_rect)
    pygame.draw.line(screen, WHITE, (0, 50), 4)
    pygame.draw.line(screen, WHITE, (0, WINDOW_HEIGHT - 100), (WINDOW_HEIGHT, WINDOW_HEIGHT - 100), 4)

    nanobot_group.update()
